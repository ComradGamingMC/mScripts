-- https://docs.fivem.net/docs/game-references/blips/ -- Use For ID 
	...
	local blips = {
{title="City Hall", colour=75, id=89, x=-544.0, y=-204.0, z=38.0},   
 -- Benefactor
{title="Benefactor Dealership", colour=75, id=67, x=-53.91, y=68.01, z=71.96},     --]]  
-- The Prison
{title="Bolingbroke Penitentiary", colour=75, id=238, x=1807.53, y=2605.59, z=45.565},
-- Airports 
{title="Airfield  - Sandy Shores", colour=3, id=90, x=1721.0, y=3255.0, z=41.0},
{title="Airfield  - Grapeseed", colour=3, id=90, x=2149.0, y=4817.0, z=41.0},
{title="Airfield  - LSIA", colour=3, id=90, x=-1045.0, y=-2751.0, z=21.0},

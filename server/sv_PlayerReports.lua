...
-----------------------------------
-- Config --
webhookURL = 'https://discord.com/api/webhooks/1016438815595958292/1x8T3DPNp18TSt0zkWembwXlYukrPj4rXgoCEdvlz_UvvAwbbH5Q4dMKUdKS_6mQpjcc'
...
RegisterCommand("report", function(source, args, rawCommand)
	...
	if tonumber(id) ~= nil then
		...
		TriggerClientEvent('chatMessage', source, "^9[^1Player-Reports^9] ^2Report has been submitted! Thank you for helping us :)")
		...
		-- It's not a number
		TriggerClientEvent('chatMessage', source, "^9[^1Player-Reports^9] ^1Invalid Format. ^1Proper Format: /report <id> <report>")
	end
end)
